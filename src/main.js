var Score = /** @class */ (function () {
    ...
    Score.prototype.createGlyph = function (code) {
        var text = this.createElement("text");
        text.textContent = String.fromCharCode(code);
        text.classList.add("glyph");
        return text;
    };
    Score.prototype.drawClef = function (name, staffPosition) {
        var _this = this;
        if (staffPosition === void 0) { staffPosition = 0; }
        var clefCodes = {
            "gClef": 0xE050,
            "fClef": 0xE062
        };
        var clef = this.useGlyph(name, function (symbol) {
            var clef = _this.createGlyph(clefCodes[name]);
            symbol.appendChild(clef);
        });
        var yValue = 32 - staffPosition * 4;
